...
//    public static final String PRODUCT_ADD_URL = "http://localhost:8080/provider/add/";
    ...
    public static final String PRODUCT_GET_URL = "http://zmodule-provider/provider/get/";
    public static final String PRODUCT_LIST_URL= "http://zmodule-provider/provider/list/";
    public static final String PRODUCT_ADD_URL = "http://zmodule-provider/provider/add/";
